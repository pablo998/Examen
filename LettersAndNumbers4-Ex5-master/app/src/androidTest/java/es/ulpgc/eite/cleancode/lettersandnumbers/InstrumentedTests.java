...
import es.ulpgc.eite.cleancode.lettersandnumbers.letters.NumberListActivity;
...
public class InstrumentedTests { // 18 tests
    ...
    @Rule
    public ActivityTestRule<NumberListActivity> rule =
        new ActivityTestRule<>(NumberListActivity.class);
